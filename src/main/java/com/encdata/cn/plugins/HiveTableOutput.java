...
package com.encdata.cn.plugins;
 ...
 * @since 6-apr-2003
 */
public class HiveTableOutput extends BaseStep implements StepInterface {
  private static Class<?> PKG = HiveTableOutputMeta.class; // for i18n purposes, needed by Translator2!!

  private HiveTableOutputMeta meta;
  private TableOutputData data;

  public HiveTableOutput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta,
    Trans trans ) {
   ...
   * @return
   */
  protected HiveTableOutputMeta getMeta() {
    return meta;
  }
  ...
  protected void setMeta( HiveTableOutputMeta meta ) {
    this.meta = meta;
  }
