...
/**
 * This takes care of the external metadata injection into the HiveTableOutputMeta class
 *
 * @author Chris
 */
public class HiveTableOutputMetaInjection implements StepMetaInjectionInterface {
  ...
  public HiveTableOutputMetaInjection( HiveTableOutputMeta meta ) {
    this.meta = meta;
  }
  ...
  public HiveTableOutputMeta getMeta() {
    return meta;
  }
}
